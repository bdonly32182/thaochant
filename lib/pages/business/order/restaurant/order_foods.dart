...
class OrderFoods extends StatefulWidget {
  String restaurantId;
  OrderFoods({Key? key, required this.restaurantId}) : super(key: key);

  @override
  State<OrderFoods> createState() => _OrderFoodsState();
}

class _OrderFoodsState extends State<OrderFoods> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(isFilter ? "คัดกรองออร์เดอร์" : "ออร์เดอร์จองอาหาร"),
        actions: isFilter
            ? [
                IconButton(
                  onPressed: () => setState(() {
  ...
  StreamBuilder<QuerySnapshot<OrderModel>> buildStreamOrders(
    ...
    return StreamBuilder(
        stream: OrderFoodCollection.orderByRestaurantId(
            widget.restaurantId, orderCategory, dateCreate!, endDate!),
        builder:
