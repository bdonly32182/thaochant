...
class CreateShippingProduct extends StatefulWidget {
  ...
  @override
  State<CreateShippingProduct> createState() => _CreateShippingProductState();
}

class _CreateShippingProductState extends State<CreateShippingProduct> {
  TextEditingController shippingNoController = TextEditingController();
  final _formKey = GlobalKey<FormState>();
  final ShippingProductModel _shippingProductModel = ShippingProductModel(
    orderId: '',
  ...
  onSubmit(ShippingProductModel shipping) async {
    if (_formKey.currentState!.validate()) {
      ...
      shipping.orderId = widget.orderId;
      Map<String, dynamic> response =
          await ShippingProductColletion.saveShippingData(shipping);
